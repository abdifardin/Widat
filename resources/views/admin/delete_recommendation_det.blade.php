				...
				<div class="translation-group">
					<form action="" method="post" id="translation-form">
						...
						<div class="form-toolbar float-right">
							<button type="submit" name="delete" value="1" class="btn btn-danger admin_delete_recomm_action_confirm_delete">
								{{ trans('common.delete') }}
							</button>
							...
							<button type="submit" name="deny" value="1" class="btn btn-info admin_delete_recomm_action_confirm_restore">
