if($("#ku_trans_abstract").length){
	...
	function event() {
		...
		if (!autosave_lock && ((current_val.localeCompare(previous_val) != 0 && current_val.localeCompare('<p><br></p>') != 0 && document.getElementById("ku_trans_abstract").value != '')
